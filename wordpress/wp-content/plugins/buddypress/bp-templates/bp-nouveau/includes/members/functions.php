...
//REMOVING ADMIN AND SUBSCRIBER IN MEMBER LOOP//
...
function bpdev_get_subscriber_user_ids(){
    ...
    $subscribers= get_users( array('role__in' => ['administrator', 'subscriber'], 'fields' => 'ID' ) ); //DO NOT SHOW ADMIN AND SUBSCRIBER IN MEMBERS, SHOW ONLY DOGS//
